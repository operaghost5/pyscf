"""Extract the final HCN...HBr geometries of the February 2026 conventional-DFT runs (aug-cc-pV5Z excluded)
...
Halogen-bonded starts (xlocal_min): a February run that did not end in a bound N...Br-H complex
(monomers separated, or collapsed to the bent C-H...Br minimum) is replaced by the PBE
halogen-bonded geometry of the same basis, and the comment line says so ('substituted: ...'),
the convention of ../hcn_hbr/.
"""
import glob
import math
import os
